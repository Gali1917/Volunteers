          ...
          <section className="cards">
            <article className="activity">
              ...
              <div className="card-content">
                ...
                {tarea.description}
                  ...
                  <p>
                    <span className="number-activity">1.</span> Plantar mínimo
                    un árbol nativo, describiendo sus características,
                    coordenadas y fotografías del lugar.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    orgánicos como compostaje o humus para aplicar en los
                    árboles plantados y describir la técnica usada mediante
                    fotografías.
                  </p>
                  <p>
                    <span className="number-activity">4.</span> Utilizar medio
                    de transporte alternativo durante una semana, subir imagen
                    de cada día, describiendo su experiencia en bicicleta,
                    patines entre otros.
                  </p>
                  <p>
                    <span className="number-activity">5.</span> Identifique una
                    norma legal ambiental, tome una fotografía y realice un
                    ensayo en la descripción.
                  </p>
                  <p>
                    <span className="number-activity">6.</span> Fruta comida,
                    semilla sembrada, construya un semillero con mínimo (3)
                    frutas diferentes, fotografié y describa las características
                    de cada una.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="number-activity">8.</span> Realizar
                    actividad física en grupo, fotografié y describa su
                    experiencia junto con el tipo de deporte utilizado, describa
                    a sus acompañantes.
                  </p>
                  <p>
                    <span className="number-activity">9.</span> Organice un
                    compa sin usar desechables e invite a familiares y amigos,
                    describa las alternativas que utilizo y comparta fotografías
                    con los invitados.
                  </p>
                </div>
              ...
              <div className="card-content">
                <div className="activity-text">
                  <p>
                    ...
                    caminata ecológica e invite a familiares y amigos, realice
                    una observación del lugar y registre los mejores momentos.
                  </p>
                  <p>
                    ...
                    residuos recuperados dándoles una disposición final
                    adecuada.
                  </p>
                  <p>
                    <span className="number-activity">12.</span> Realice
                    investigación sobre la meditación y sus beneficios, ubique
                    un lugar y póngalo en práctica, preferiblemente en la
                    naturaleza.
                  </p>
                  <p>
                    <span className="number-activity">13.</span> Fotografiar un
                  ...
                  <p>
                    ...
                    electrodomésticos una hora durante una semana. Evidenciando
                    el proceso diario mediante fotografías.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    alternativas orgánicas en los productos de aseo personal y
                    del hogar en general, para reducir el uso de productos
                    derivados del petróleo, investigue en su localidad.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="number-activity">18.</span> Determine cómo
                    su cultura local puede ayudar a la preservación del ambiente
                    por medio de técnicas, costumbres y tradiciones.
                  </p>
                </div>
            ...
            <article className="activity">
              ...
              <div className="card-content">
                <div className="activity-text">
                  <p>
                    <span className="number-activity">19.</span> Por la
                    seguridad alimentaria, inicia un huerto orgánico casero,
                    recuperando semillas y esquejes de plantas usadas en la
                    cocina como cebolla, ajo, tomate, pimentón, entre otros.
                    Describa el proceso y registre mediante fotografías.
                  </p>
                  <p>
                    <span className="number-activity">20.</span> Idear método
                    para reducir consumo de agua en el hogar. Determine el
                    ahorro mensual, llenando la matriz anexada. Registre todo el
                    proceso mediante fotografías.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="number-activity">27.</span> Proponer un
                    plan para la reducción de impactos ambientales para su
                    cuenca hidrográfica, teniendo en cuenta las necesidades de
                    la comunidad y la protección de los recursos naturales.
                    registre su experiencia.
                  </p>
                </div>
